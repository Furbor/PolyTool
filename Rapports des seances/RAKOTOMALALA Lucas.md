...
• J'ai alors testé le module <strong>LOGO-sensor Ver1.3</strong>, dont le code est disponible <a href="https://github.com/PolyTool/PolyTool/blob/master/Codes%20Arduino/LOGO-sensor%20Ver1.3.ino">ici</a>, mais un problème persiste. Il ne semble pas faire le distinction entre la présence d'aimant ou non.
<br>
...
• Tout d'abord, j'ai essayé de faire fonctionner le module <strong>LM335Z</strong>, sans succès, malgré de nombreuses recherches sur des forums (anglais et celui d'Arduino français). J'ai également regardé le <em>datasheet</em> du module, qui est disponible <a href="http://www.datasheetcatalog.net/datasheets_pdf/L/M/3/3/LM335Z.shtml">ici</a>. Je n'ai tout de même pas réussi à avoir une température correcte. J'ai alors donné le relais à mon camarade <strong>Damien</strong> pour qu'il tente à son tour de faire fonctionner ce module.
